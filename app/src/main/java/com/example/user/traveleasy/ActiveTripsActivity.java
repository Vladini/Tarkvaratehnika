...
public class ActiveTripsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (final Trip trip : trips) {
            ...
            TextView tv2 = new TextView(ActiveTripsActivity.this);
            tv1.setTextSize(18);
            tv2.setTextSize(18);
            ...
            tv1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(ActiveTripsActivity.this, TripsCalendarActivity.class));
                    TripsCalendarActivity.index = trip.getId();
                }
            });
            try{
